export const STAGE_BACKGROUND_COLOR = '#ffecb3';

export const TABLE_TEXT_COLOR = '#80cbc4';
export const TABLE_BACKGROUND_COLOR = '#4db6ac';
export const TABLE_HIGHLIGHT_COLOR = '#80cbc4';
export const TABLE_SHADOW_COLOR = '#00695c';

export const FACE_UP_CARD_BACKGROUND_COLOR = '#fffde7';
export const BLACK_SUITS_COLOR = '#37474f';
export const RED_SUITS_COLOR = '#ef5350';
